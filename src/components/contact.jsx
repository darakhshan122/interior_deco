    ...
    >
      ...
      <div className="flex flex-col md:flex-row items-center justify-center p-6 md:p-12 bg-black bg-opacity-80 max-w-screen-lg rounded-lg shadow-2xl">
        ...
        <div className="md:w-1/2 flex flex-col items-start justify-center space-y-4 md:ml-8 text-white">
          <h2 style={{ fontFamily: 'Playfair Display, serif' }} className="text-2xl font-bold mb-4">Connect with us</h2>
          <p style={{ fontFamily: 'Merriweather, serif' }}>Reach out on WhatsApp, Instagram, or give us a call for the best home design experience.</p>

          {/* Address */}
          <div className="flex items-start space-x-2">
            <p>
              <strong style={{ fontFamily: 'Merriweather, serif' }}>Address:</strong> A-101, Raju Park, devli road, Khanpur, New Delhi - 110062
            </p>
          </div>
          ...
          <div className="flex items-start space-x-2">
            <p>
              <strong style={{ fontFamily: 'Merriweather, serif' }}>Phone:</strong> +91-97178 79668,+91-99719 67594
            </p>
          </div>

          {/* WhatsApp Contact */}
          <div className="relative group">
            <a href="https://wa.me/9717879668" 
            target="_blank" 
