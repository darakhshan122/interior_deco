...
//   img41,img42,img43,img44,img45,img46,img47,img48,img49,img50,img51,img52,img53,img54,img55,
//   img56,img58,img57,img59,img60,
// ];
...
//         <div style={{ backgroundImage: `url(${img9})` }} className="flex flex-col md:flex-row  gap-0  rounded-lg shadow-2xl h-[70vh]">
//           {/* Image Div */}
...
//             <p style={{ fontFamily: 'Merriweather, serif' }} className="text-lg md:text-xl text-center text-white">
//               We provide state-of-the-art office designs to enhance your workspace and productivity. Contact us to learn more about our services.
//             </p>
//           </div>
//         </div>
...
//           <p style={{ fontFamily: 'Playfair Display, serif' }} className="text-2xl font-bold mb-4">OUR WORK</p>
...
function Gallery() {
  ...
  return (
    <div className="p-6 md:p-12 mt-[10vh]">
      ...
      {fullImage && (
        <div className="fixed inset-0 bg-black bg-opacity-80 flex items-center justify-center z-50" onClick={handleCloseFullImage}>
          <img src={fullImage} alt="Full-Screen" className="max-w-full max-h-full" />
        </div>
      )}
    </div>
  );
